    ...
    <div className="relative">
      ...
      <div className="fixed inset-0 w-full h-full -z-10">
        ...
        <div 
          ...
          style={{
            background: 'radial-gradient(circle, rgba(52, 211, 153, 0.8) 0%, rgba(196, 165, 255, 0.5) 50%, transparent 100%)',
          }}
        />
        {/* Right-center blob */}
        <div 
          ...
          style={{
            background: 'radial-gradient(circle, rgba(56, 189, 248, 0.7) 0%, rgba(196, 165, 255, 0.4) 50%, transparent 100%)',
          }}
        />
      </div>
